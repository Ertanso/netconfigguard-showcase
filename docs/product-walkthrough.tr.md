...
Gerçek uygulama ekranlarından hazırlanmış, Türkçe sentetik sesli ürün turu. Ses: Ahmet Neural. İnsan sesi klonlanmamıştır. Gömülü Türkçe altyazı ve bu çalışma için sentezlenmiş özgün, kısık arka plan sesi eklenmiştir. Konuşma sırasında arka plan seviyesi otomatik azaltılır.
...
Güvenlik ürünleriniz çalışıyor. Peki, amaçladığınız korumayı sağladıklarından emin misiniz? Bir erişim kuralı genişler, bir yetki değişir, kayıt tutma kapanır. Hizmet devam eder; ama koruma sınırları değişmiş olabilir. Net Config Guard, bu değişiklikleri kanıtlarıyla incelemeye açmak için geliştiriliyor. Önce gerçek bir analiz örneğine bakalım. Ardından, bu bulgunun envanterden rapora nasıl taşındığını birlikte inceleyelim. Görüntüler sentetik laboratuvar verisinden üretilen gerçek uygulama çıktıları.

## 00:43 — Semantik karşılaştırma
...
## 01:51 — Operasyon kontrol paneli
...
## 05:52 — Tek snapshot güvenlik denetimi
...
## 06:58 — Kontrol değerlendirmeleri
...
## 08:10 — Paylaşılabilir cihaz raporu
...
## 09:21 — Politika ve kontrol kataloğu
...
## 09:57 — Cisco IOS statik denetimi
...
## 11:08 — Yapılandırmadan kanıta

Güvenlik ürününün çalıştığını görmek, yapılandırmanın amaçlanan korumayı sürdürdüğünü doğrulamakla aynı şey değil. Net Config Guard bu incelemeyi; değişiklik, kanıt, risk ve rapor üzerinden destekliyor. Bugün desteklenen ağ cihazı ve güvenlik duvarı yapılandırmalarıyla başlıyoruz. Vizyonumuz daha geniş: yapılandırılabilir cihazları, güvenlik ürünlerini ve sistemleri tek panelden yönetmek. Kim, nerede, ne değiştirdi sorusunu yanıtlamak, yöneticiyi anında bilgilendirmek ve kör noktaları azaltmak. Bunlar sonraki geliştirme hedefleri. Proje alpha ve laboratuvar aşamasında. Sizin ortamınızda hangi değişiklik gözden kaçmamalı? Teknik kapsam ve örnek rapor, tanıtım deposunda.
